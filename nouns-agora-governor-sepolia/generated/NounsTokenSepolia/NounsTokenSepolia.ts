...
export class NoundersDAOUpdated extends ethereum.Event {
  get params(): NoundersDAOUpdated__Params {
    return new NoundersDAOUpdated__Params(this);
  }
}

export class NoundersDAOUpdated__Params {
  _event: NoundersDAOUpdated;

  constructor(event: NoundersDAOUpdated) {
    this._event = event;
  }

  get noundersDAO(): Address {
    return this._event.parameters[0].value.toAddress();
  }
}
...
export class NounsTokenSepolia__checkpointsResult {
  value0: BigInt;
  value1: BigInt;
...
export class NounsTokenSepolia__seedsResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
  value3: BigInt;
...
export class NounsTokenSepolia extends ethereum.SmartContract {
  static bind(address: Address): NounsTokenSepolia {
    return new NounsTokenSepolia("NounsTokenSepolia", address);
  }
  ...
  checkpoints(
    param0: Address,
    param1: BigInt
  ): NounsTokenSepolia__checkpointsResult {
    let result = super.call(
      "checkpoints",
    ...
    return new NounsTokenSepolia__checkpointsResult(
      result[0].toBigInt(),
      result[1].toBigInt()
    );
  }
  ...
  try_checkpoints(
    param0: Address,
    param1: BigInt
  ): ethereum.CallResult<NounsTokenSepolia__checkpointsResult> {
    let result = super.tryCall(
      "checkpoints",
      "checkpoints(address,uint32):(uint32,uint96)",
      [
    ...
    return ethereum.CallResult.fromValue(
      new NounsTokenSepolia__checkpointsResult(
        value[0].toBigInt(),
        value[1].toBigInt()
      )
    );
  ...
  seeds(param0: BigInt): NounsTokenSepolia__seedsResult {
    let result = super.call(
      "seeds",
    ...
    return new NounsTokenSepolia__seedsResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt(),
      result[3].toBigInt(),
  ...
  try_seeds(
    param0: BigInt
  ): ethereum.CallResult<NounsTokenSepolia__seedsResult> {
    let result = super.tryCall(
      "seeds",
      "seeds(uint256):(uint48,uint48,uint48,uint48,uint48)",
      [ethereum.Value.fromUnsignedBigInt(param0)]
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new NounsTokenSepolia__seedsResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBigInt(),
        value[3].toBigInt(),
...
export class SetNoundersDAOCall extends ethereum.Call {
  get inputs(): SetNoundersDAOCall__Inputs {
    return new SetNoundersDAOCall__Inputs(this);
  }

  get outputs(): SetNoundersDAOCall__Outputs {
    return new SetNoundersDAOCall__Outputs(this);
  }
}

export class SetNoundersDAOCall__Inputs {
  _call: SetNoundersDAOCall;

  constructor(call: SetNoundersDAOCall) {
    this._call = call;
  }
...
export class SetNoundersDAOCall__Outputs {
  _call: SetNoundersDAOCall;
